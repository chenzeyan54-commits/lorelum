...
When a question is provided, treat it as the retrieval focus: run one targeted natural-language `lore query` for it, then read the full body of every candidate Practice with `lore get <practice-id>`.
